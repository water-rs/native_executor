...
## [0.8.0](https://github.com/water-rs/native_executor/compare/v0.7.0...v0.8.0) - 2026-08-10

### Added

- [**breaking**] split the main-thread executor out of NativeExecutor

### Other

- enable KVM and stop guessing where cargo puts test binaries
